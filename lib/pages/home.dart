  ...
  AppBar buildAppBar() {
    return AppBar(
        ...
        child:Container(
         ...
         child: Center(child: Image.network("https://cdn-icons-png.flaticon.com/512/271/271220.png",height: 20,width: 20,)),
          decoration: BoxDecoration(
        ...
        child:Container(
            ...
            alignment: Alignment.center,
            width: 37,
            child: Center(child:Image.network("https://www.pictoclub.com/wp-content/uploads/2015/10/SEA00011C-TWO-DOTS.jpg",height: 20,width: 20,)),
            decoration: BoxDecoration(
              color:const Color(0xffF7F8F8),
              borderRadius: BorderRadius.circular(10),
            ),
